/*  
Question: Find the nth term of the factorial series elements.
Write a program in C++ to find the nth term of the factorial series, where,
Factorial Series: 0, 1, 1, 2, 3, 5, 8, 13, 21 ...
*/
